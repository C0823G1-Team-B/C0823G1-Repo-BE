...
public class PrintPDF {
    public static void printPDF(ITicketDTO1 iTicketDTO1) {
        ...
        try {
            ...
            PdfWriter pdfWriter = PdfWriter.getInstance(document, new FileOutputStream("C:\\Users\\ADMIN\\Desktop\\PDF\\vexe" + iTicketDTO1.getId() + ".pdf"));
            document.open();
            PdfContentByte contentByte = pdfWriter.getDirectContentUnder();
            Image backgroundImage = Image.getInstance("D:\\Codegym\\Case_Study_04\\C0823G1-Repo-BE\\ticket_management\\src\\main\\java\\com\\example\\ticket_management\\pdf\\pngtree-black-minimalist-atmospheric-wooden-background-backgroundwooden-backgroundtree-texture-image_77053.jpg");
            ...
            BaseFont baseFont = BaseFont.createFont("D:\\Codegym\\Case_Study_04\\C0823G1-Repo-BE\\ticket_management\\src\\main\\java\\com\\example\\ticket_management\\pdf\\arial-unicode-ms.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED);
            ...
            Image image1 = Image.getInstance("D:\\Codegym\\Case_Study_04\\C0823G1-Repo-BE\\ticket_management\\src\\main\\java\\com\\example\\ticket_management\\pdf\\hieuhoa_logo_trang.png");
